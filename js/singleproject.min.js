  ...
  const W = {
      attachEvents: function () {
        ...
        (e.onTouchStart = G.bind(e)),
          ...
          (e.onClick = j.bind(e)),
          i.touch && !H && (t.addEventListener("touchstart", V), (H = !0)),
          q(e, "on");
      },
  ...
  ee.use([
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      (e.autoplay = { running: !1, paused: !1 }),
        ...
        Object.assign(e.autoplay, { pause: d, run: a, start: l, stop: o });
    },
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function c() {
        ...
        if ("bullets" === t.type) {
          ...
          n.html(a), (e.pagination.bullets = n.find(se(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((a = t.renderFraction
    ...
    document.addEventListener("DOMContentLoaded", function () {
      re(".feedback_slider", ".feedback_slider-pagination", {
        slidesPerView: 1,
        spaceBetween: 30,
        breakpoints: {
