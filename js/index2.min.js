(() => {
  ...
  function re(e) {
    for (var t = 1; t < arguments.length; t++) {
      ...
      t % 2
        ? ne(Object(i), !0).forEach(function (t) {
            s(e, t, i[t]);
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(i))
        : ne(Object(i)).forEach(function (t) {
  ...
  function le() {
    var e = { loop: !0, autoplay: { disableOnInteraction: !1 }, speed: 1500 },
      t = new ee(
        ".hero_slider--thumbs",
        re(
          re({}, e),
      ...
      n = function (e) {
        var t = document.querySelectorAll(".hero_slider--main .swiper-slide"),
          s = [];
        t.forEach(function (e) {
          s.push(e.dataset.bg);
        });
        var n = Array.from(new Set(s)).sort();
    ...
    n(0),
      s.on("slideChange", function () {
        var e = s.slides[s.activeIndex].dataset.swiperSlideIndex;
        n(e);
      });
    var r = document.querySelector(".container_regular"),
      a = document.querySelector(".container_thumbs"),
      l = function () {
        var e = "rtl" === document.documentElement.dir;
        if (window.innerWidth > 1365.98) {
          ...
          e ? (a.style.marginRight = t) : (a.style.marginLeft = t);
        } else a.style.margin = "0 auto";
      };
    l(),
      window.addEventListener("resize", l),
      document.documentElement.addEventListener("dirchange", l);
  }
  function oe(e, t) {
  ...
  var ce = function e(t, s) {
    ...
    if (t && s && "object" == typeof t && "object" == typeof s) {
      ...
      if (Array.isArray(t)) {
        ...
        for (n = i; 0 != n--; ) if (!e(t[n], s[n])) return !1;
        return !0;
      }
      ...
      if ((i = (r = Object.keys(t)).length) !== Object.keys(s).length)
        return !1;
      for (n = i; 0 != n--; )
        if (!Object.prototype.hasOwnProperty.call(s, r[n])) return !1;
      for (n = i; 0 != n--; ) {
        var a = r[n];
  ...
  class he {
    constructor({
      ...
      if (
        ...
        if (!ce(this.options, he.instance.options))
          throw new Error(
            `Loader must not be called again with different options. ${JSON.stringify(
              this.options
            )} !== ${JSON.stringify(he.instance.options)}`
          );
        return he.instance;
      }
      he.instance = this;
  ...
  var fe = [
    ...
    me = "AIzaSyA_MQQgSumzx3yMIfz4n5Trl_FTSbiWOQo";
  document.addEventListener("DOMContentLoaded", function () {
    var e, t, s, i;
    le(),
      ae(".feedback_slider", ".feedback_slider-pagination", {
        slidesPerView: 1,
        spaceBetween: 30,
        breakpoints: {
          767.98: { slidesPerView: 2 },
      ...
      (function () {
        ...
        function r() {
          var s =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : 3e3;
          e[0].classList.add("is-complete"),
            e.forEach(function (e, i) {
              (t[i].style.animationDelay = "".concat(s, "ms")),
                e.children,
                setTimeout(function () {
                    ...
                    (function (e, t) {
                      if (e.classList) e.classList.toggle(t);
                        ...
                        var s = e.className.split(" "),
                          i = s.indexOf(t);
                        i >= 0 ? s.splice(i, 1) : s.push(t),
                          (e.className = s.join(" "));
                      }
                    })(e.nextElementSibling, "is-complete");
                }, s * i);
            });
        }
        window.addEventListener("load", n),
          ...
          window.addEventListener("load", function () {
            ...
            new IntersectionObserver(r, e).observe(s);
          });
      })(),
      (e = "#map"),
      (t = new he({ apiKey: me, version: "weekly" })),
      (s = document.querySelector(e)),
      (i = { lat: 40.74881584652125, lng: -73.98561648634562 }),
      s &&
        t.load().then(function () {
          var e = {
            ...
            t = new google.maps.Map(s, {
              center: { lat: 40.74956081164776, lng: -73.98700531672688 },
              zoom: 12,
              styles: de(fe),
              disableDefaultUI: !0,
            });
          new google.maps.Marker({ position: i, map: t, icon: e });
        });
  });
})();
